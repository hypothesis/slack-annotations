...
coverage: python
	@pyenv exec tox --parallel -qe 'tests,py{312,311}-tests,coverage'
...
sure: python
sure:
	@pyenv exec tox --parallel -qe 'checkformatting,lint,typecheck,tests,py{312,311}-tests,coverage,functests,py{312,311}-functests'
